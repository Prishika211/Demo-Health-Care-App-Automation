...
public class DemoHealthCareApp {
    ...
    public void userNavigatesToTheHealthApp() throws MalformedURLException {
...
//        options.setAppActivity("com.reddit.launch.main.MainActivity");
    ...
    public void heClicksOnNextPages() {
        //First Page
    ...
    public void heIsSuccessfullyAbleToNavigateAndValidateTheApp() {
        wait.until(ExpectedConditions.elementToBeClickable(
